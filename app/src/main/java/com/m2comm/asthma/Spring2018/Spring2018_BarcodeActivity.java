...
public class Spring2018_BarcodeActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.back :
                ...
                break;
            case R.id.menu:
                intent = new Intent(Spring2018_BarcodeActivity.this, Spring2018_SideMenu.class);
    ...
    /*
        ...
        */
        ...
        barcode_text.setText(prefs.getString("Spring2018_gubun","")+"-"+prefs.getString("Spring2018_sid","")+"A");
        try {
            final int WIDTH = 700;
            final int HEIGHT = 250;
            BitMatrix bytemap = gen.encode(prefs.getString("Spring2018_gubun","")+"-"+prefs.getString("Spring2018_sid","")+"A", BarcodeFormat.CODE_128, WIDTH, HEIGHT);
    ...
    protected void onResume() {
        ...
        mThread = new Thread() {
            public void run() {
                String urlStr = Global.Spring2018_URL+"get_attendance.php?userid=" + prefs.getString("Spring2018_gubun","")+"-"+prefs.getString("Spring2018_sid","");
                while(check) {
                    try {
