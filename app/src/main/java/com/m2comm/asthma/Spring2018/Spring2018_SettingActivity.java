...
import com.m2comm.asthma.Spring2018.Spring2018_SettingActivity;
...
public class Spring2018_SettingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spring2018_setting);
        ...
        HttpAsyncTask question = new HttpAsyncTask(Spring2018_SettingActivity.this, new HttpInterface() {
            @Override
        ...
        question.execute(new HttpParam("url", Global.Spring2018_URL + "get_pushYN.php"),
        ...
        public void handleMessage(Message msg)
        {
            if(msg.what==1)
            {
                ...
                try {
                    ...
                    adapter.add(new SetClass("alarm","Notice",resultList.getString("alarm")));
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    question.execute(new HttpParam("url",Global.Spring2018_URL + "set_pushYN.php"),
                            new HttpParam("val", SetInfo.alarm),
                            new HttpParam("token", prefs.getString("registration_id", "")));

                    loadingDialog = new LoadingDialog(Spring2018_SettingActivity.this);
