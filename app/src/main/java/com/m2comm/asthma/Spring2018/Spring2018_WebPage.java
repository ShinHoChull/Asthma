...
public class Spring2018_WebPage extends Activity {
    M2WebView webview;
    LinearLayout menu;
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.spring2018_web);
        webview = (M2WebView) findViewById(R.id.webview);
        menu = (LinearLayout) findViewById(R.id.menu);
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Spring2018_WebPage.this, Spring2018_SideMenu.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Spring2018_WebPage.this, Spring2018_MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                {
                    Intent intent = new Intent(Spring2018_WebPage.this, Voting.class);
                    startActivity(intent);
                    return true;
                }
                            ...
                            .setPositiveButton(android.R.string.ok,
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            Intent intent = new Intent(Spring2018_WebPage.this, Spring2018_LoginActivity.class);
                ...
                {
                    new PDF(Spring2018_WebPage.this, url);
                }
                return false;
            }
        });
