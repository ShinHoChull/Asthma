...
public class Fall2019_WebPopupActivity extends Activity implements View.OnClickListener{
    M2WebView webview;
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains("back.php")) {
                    ...
                    Intent intent = new Intent(Fall2019_WebPopupActivity.this, ImageViewActivity.class);
            ...
            */
                    ...
                    Alarm alarm = new Alarm(Fall2019_WebPopupActivity.this);
                    int day = 10;
                    ...
                    try {
                        ...
                        Toast.makeText(Fall2019_WebPopupActivity.this, "Add Alarm", Toast.LENGTH_SHORT).show();
                    ...
                    if(!prefs.getString("Spring2019_gubun","").equals("")) {
                        new PDF(Fall2019_WebPopupActivity.this, url);
                    }else{
                                ...
                                .setPositiveButton(android.R.string.ok,
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent intent = new Intent(Fall2019_WebPopupActivity.this, Fall2019_LoginActivity.class);
