...
public class Fall2019_SettingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fall2019_setting);
        ...
        HttpAsyncTask question = new HttpAsyncTask(Fall2019_SettingActivity.this, new HttpInterface() {
            @Override
        ...
        question.execute(new HttpParam("url", Global.Fall2019_URL + "get_pushYN.php"),
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    loadingDialog = new LoadingDialog(Fall2019_SettingActivity.this);
