...
public class Spring2017_MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spring2017_main);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.home :
                intent = new Intent(Spring2017_MainActivity.this, MainActivity.class);
                startActivity(intent);
                break;
            case R.id.menu :
                intent = new Intent(Spring2017_MainActivity.this, Spring2017_SideMenu.class);
                startActivity(intent);
                overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
                break;
            case R.id.menu1 :
                intent = new Intent(Spring2017_MainActivity.this, Spring2017_WebPage.class);
                intent.putExtra("page", Global.Spring2017_URL+"message.php");
                startActivity(intent);
                break;
            case R.id.menu2 :
                intent = new Intent(Spring2017_MainActivity.this, Spring2017_WebPage.class);
                intent.putExtra("page", Global.Spring2017_URL+"program.php?spring2017_sid="+prefs.getString("Spring2017_sid","")+"&spring2017_gubun="+prefs.getString("Spring2017_gubun",""));
                startActivity(intent);
            ...
            case R.id.menu3 :
                ...
                else
                {
                    ...
                    startActivity(intent);
                    /*
                    new AlertDialog.Builder(Spring2017_MainActivity.this)
                            .setTitle("대한천식알레르기학회")
                            .setMessage("사전등록 확인을 위해 로그인이 필요합니다. 로그인을 하시겠습니까?")
                            .setPositiveButton(android.R.string.ok,
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            Intent intent = new Intent(Spring2017_MainActivity.this, LoginActivity.class);
            ...
            case R.id.menu4 :
                intent = new Intent(Spring2017_MainActivity.this, Spring2017_WebPage.class);
                intent.putExtra("page", Global.Spring2017_URL+"location_01.php");
                startActivity(intent);
                break;
            case R.id.menu5 :
                intent = new Intent(Spring2017_MainActivity.this, Spring2017_WebPage.class);
                intent.putExtra("page", Global.Spring2017_URL+"venue.php");
                startActivity(intent);
                break;

            case R.id.menu6 :
                intent = new Intent(Spring2017_MainActivity.this, Spring2017_WebPage.class);
                intent.putExtra("page", Global.Spring2017_URL+"bbs/list.php");
                startActivity(intent);
                break;
            case R.id.search :
                intent = new Intent(Spring2017_MainActivity.this, Spring2017_WebPage.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent.putExtra("page", Global.Spring2017_URL+"search.php?spring2017_gubun=" + prefs.getString("Spring2017_gubun","") + "&spring2017_sid=" + prefs.getString("Spring2017_sid",""));
                startActivity(intent);
                ...
                */
                break;
            case R.id.voting :
                intent = new Intent(Spring2017_MainActivity.this, Voting.class);
                startActivity(intent);
                break;
        }
    }
