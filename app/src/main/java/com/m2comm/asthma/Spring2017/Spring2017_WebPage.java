...
public class Spring2017_WebPage extends Activity {
    M2WebView webview;
    LinearLayout menu;
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.spring2017_web);
        webview = (M2WebView) findViewById(R.id.webview);
        menu = (LinearLayout) findViewById(R.id.menu);
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Spring2017_WebPage.this, Spring2017_SideMenu.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Spring2017_WebPage.this, Spring2017_MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                {
                    Intent intent = new Intent(Spring2017_WebPage.this, Voting.class);
                    startActivity(intent);
                    return true;
                }
                            ...
                            .setPositiveButton(android.R.string.ok,
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            Intent intent = new Intent(Spring2017_WebPage.this, Spring2017_LoginActivity.class);
                ...
                else if (url.endsWith(".pdf"))
                {
                   //String a[] = url.split("file=");
                    ...
                    new PDF(Spring2017_WebPage.this, url);
                }
                return false;
            }
        });
