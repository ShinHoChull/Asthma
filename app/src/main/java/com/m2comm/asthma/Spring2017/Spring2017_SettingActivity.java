...
public class Spring2017_SettingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HttpAsyncTask question = new HttpAsyncTask(Spring2017_SettingActivity.this, new HttpInterface() {
            @Override
        ...
        question.execute(new HttpParam("url", Global.Spring2017_URL + "get_pushYN.php"),
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    question.execute(new HttpParam("url",Global.Spring2017_URL + "set_pushYN.php"),
                            new HttpParam("val", SetInfo.alarm),
                            new HttpParam("token", prefs.getString("registration_id", "")));

                    loadingDialog = new LoadingDialog(Spring2017_SettingActivity.this);
