...
import com.m2comm.asthma.Fall2018.Fall2018_SettingActivity;
...
public class Fall2018_SettingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HttpAsyncTask question = new HttpAsyncTask(Fall2018_SettingActivity.this, new HttpInterface() {
            @Override
        ...
        question.execute(new HttpParam("url", Global.Fall2018_URL + "get_pushYN.php"),
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    question.execute(new HttpParam("url",Global.Fall2018_URL + "set_pushYN.php"),
                            new HttpParam("val", SetInfo.alarm),
                            new HttpParam("token", prefs.getString("registration_id", "")));

                    loadingDialog = new LoadingDialog(Fall2018_SettingActivity.this);
