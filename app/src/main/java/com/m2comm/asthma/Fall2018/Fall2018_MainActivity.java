...
public class Fall2018_MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fall2018_main);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.home :
                intent = new Intent(Fall2018_MainActivity.this, MainActivity.class);
                startActivity(intent);
                break;
            case R.id.menu :
                intent = new Intent(Fall2018_MainActivity.this, Fall2018_SideMenu.class);
                startActivity(intent);
                overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
                break;
            case R.id.menu1 :
                intent = new Intent(Fall2018_MainActivity.this, Fall2018_WebPage.class);
                intent.putExtra("page", Global.Fall2018_URL+"info/index.php");
                startActivity(intent);
                break;
            case R.id.menu2 :
                intent = new Intent(Fall2018_MainActivity.this, Fall2018_WebPage.class);
                intent.putExtra("page", Global.Fall2018_URL+"program/list.php?Fall2018_sid="+prefs.getString("Fall2018_sid","")+"&Fall2018_gubun="+prefs.getString("Fall2018_gubun",""));
                startActivity(intent);
                            ...
                            .setPositiveButton(android.R.string.ok,
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            Intent intent = new Intent(Fall2018_MainActivity.this, Fall2018_LoginActivity.class);
            ...
            case R.id.menu4 :
                intent = new Intent(Fall2018_MainActivity.this, Fall2018_WebPage.class);
                intent.putExtra("page", Global.Fall2018_URL+"map.php");
                startActivity(intent);
                break;
            case R.id.menu5 :
                intent = new Intent(Fall2018_MainActivity.this, Fall2018_WebPage.class);
                intent.putExtra("page", Global.Fall2018_URL+"venue.php");
                startActivity(intent);
                break;

            case R.id.menu6 :
                intent = new Intent(Fall2018_MainActivity.this, Fall2018_WebPage.class);
                intent.putExtra("page", Global.Fall2018_URL+"bbs/list.php");
                startActivity(intent);
                break;
            case R.id.search :
                intent = new Intent(Fall2018_MainActivity.this, Fall2018_WebPage.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent.putExtra("page", Global.Fall2018_URL+"search.php?Fall2018_gubun=" + prefs.getString("Fall2018_gubun","") + "&Fall2018_sid=" + prefs.getString("Fall2018_sid",""));
                startActivity(intent);
                ...
                */
                break;
            case R.id.voting :
                intent = new Intent(Fall2018_MainActivity.this, Voting.class);
                startActivity(intent);
                break;
        }
    }
