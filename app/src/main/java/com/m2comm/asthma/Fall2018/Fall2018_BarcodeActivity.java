...
public class Fall2018_BarcodeActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.back :
                ...
                break;
            case R.id.menu:
                intent = new Intent(Fall2018_BarcodeActivity.this, Fall2018_SideMenu.class);
                startActivity(intent);
                overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
                break;

            case R.id.home:
                intent = new Intent(Fall2018_BarcodeActivity.this, Fall2018_MainActivity.class);
    ...
    /*
        ...
        */
        ...
        barcode_text.setText(prefs.getString("Fall2018_gubun","")+"-"+prefs.getString("Fall2018_sid","")+"A");
        try {
            final int WIDTH = 700;
            final int HEIGHT = 250;
            BitMatrix bytemap = gen.encode(prefs.getString("Fall2018_gubun","")+"-"+prefs.getString("Fall2018_sid","")+"A", BarcodeFormat.CODE_128, WIDTH, HEIGHT);
    ...
    protected void onResume() {
        ...
        mThread = new Thread() {
            public void run() {
                String urlStr = Global.Fall2018_URL+"get_attendance.php?userid=" + prefs.getString("Fall2018_gubun","")+"-"+prefs.getString("Fall2018_sid","");
                while(check) {
                    try {
