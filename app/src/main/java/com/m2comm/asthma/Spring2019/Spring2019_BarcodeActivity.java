...
public class Spring2019_BarcodeActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.back :
                ...
                break;
            case R.id.menu:
                intent = new Intent(Spring2019_BarcodeActivity.this, Spring2019_SideMenu.class);
    ...
    /*
        ...
        */
        ...
        barcode_text.setText(prefs.getString("Spring2019_gubun","")+"-"+prefs.getString("Spring2019_sid","")+"A");
        try {
            final int WIDTH = 700;
            final int HEIGHT = 250;
            BitMatrix bytemap = gen.encode(prefs.getString("Spring2019_gubun","")+"-"+prefs.getString("Spring2019_sid","")+"A", BarcodeFormat.CODE_128, WIDTH, HEIGHT);
    ...
    protected void onResume() {
        ...
        mThread = new Thread() {
            public void run() {
                String urlStr = Global.Spring2019_URL+"get_attendance.php?userid=" + prefs.getString("Spring2019_gubun","")+"-"+prefs.getString("Spring2019_sid","");
                while(check) {
                    try {
