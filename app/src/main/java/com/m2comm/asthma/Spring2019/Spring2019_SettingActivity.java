...
public class Spring2019_SettingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spring2019_setting);
        ...
        HttpAsyncTask question = new HttpAsyncTask(Spring2019_SettingActivity.this, new HttpInterface() {
            @Override
        ...
        question.execute(new HttpParam("url", Global.Spring2019_URL + "get_pushYN.php"),
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    question.execute(new HttpParam("url",Global.Spring2019_URL + "set_pushYN.php"),
                            new HttpParam("val", SetInfo.alarm),
                            new HttpParam("token", prefs.getString("registration_id", "")));

                    loadingDialog = new LoadingDialog(Spring2019_SettingActivity.this);
