...
public class Spring2019_SideMenu extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spring2019_sidemenu);
        ...
        */
        ...
        subSideMenuClass.add(new SubSideMenuClass("- Information", Global.Spring2019_URL + "info/index.php"));
        subSideMenuClass.add(new SubSideMenuClass("- Invitation", Global.Spring2019_URL + "info/infoMess.php"));

        sidemenuadapter.add(new SideMenuClass("Information", null, subSideMenuClass));

        subSideMenuClass = new ArrayList<SubSideMenuClass>();
        subSideMenuClass.add(new SubSideMenuClass("- May 10 (Fri)", "http://ezv.kr/voting/php/session/list.php?code=allergy2019s&tab=31&deviceid=" + device));
        subSideMenuClass.add(new SubSideMenuClass("- May 11 (Sat)", "http://ezv.kr/voting/php/session/list.php?code=allergy2019s&tab=32&deviceid=" + device));
        subSideMenuClass.add(new SubSideMenuClass("- Program at a Glance", "http://ezv.kr/voting/php/session/glance.php?code=allergy2019s&deviceid=" + device));
        ...
        subSideMenuClass = new ArrayList<SubSideMenuClass>();
        subSideMenuClass.add(new SubSideMenuClass("- Incheon Airport", Global.Spring2019_URL + "tran/incheon.php"));
        subSideMenuClass.add(new SubSideMenuClass("- Gimpo Airport", Global.Spring2019_URL + "tran/gimpo.php"));
        sidemenuadapter.add(new SideMenuClass("Transportation", null, subSideMenuClass));

        sidemenuadapter.add(new SideMenuClass("Venue", Global.Spring2019_URL + "venue.php", null));


        subSideMenuClass = new ArrayList<SubSideMenuClass>();
        subSideMenuClass.add(new SubSideMenuClass("- Sponsorship", Global.Spring2019_URL + "spon/sponsor.php"));
        subSideMenuClass.add(new SubSideMenuClass("- Booth", Global.Spring2019_URL + "spon/booth.php"));
        sidemenuadapter.add(new SideMenuClass("Sponsorship", Global.Spring2019_URL + null, subSideMenuClass));
        sidemenuadapter.add(new SideMenuClass("Notice", "http://ezv.kr/voting/php/bbs/list.php?code=allergy2019s", null));
        ...
        menu_list.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v,
                ...
                if (sidemenuadapter.SideMenuList.get(groupPosition).SubSideMenuList == null) {
                    ...
                    {
                        if(!prefs.getString("Spring2019_gubun","").equals("")) {
                            intent = new Intent(Spring2019_SideMenu.this, Spring2019_WebPage.class);
                            intent.putExtra("page", Global.Spring2019_URL+"regist/index.php?Spring2019_gubun=" + prefs.getString("Spring2019_gubun","") + "&Spring2019_sid=" + prefs.getString("Spring2019_sid",""));
                            startActivity(intent);
                            finish();
                        }
                        else
                        {
                            new AlertDialog.Builder(Spring2019_SideMenu.this,R.style.AlertDialogCustom)
                                    .setTitle("대한천식알레르기학회")
                                    .setMessage("Please login")
                                    .setPositiveButton(android.R.string.ok,
                                            new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int which) {
                                                    Intent intent = new Intent(Spring2019_SideMenu.this, Spring2019_LoginActivity.class);
        ...
        menu_list.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if(!sidemenuadapter.getGroup(groupPosition).SubSideMenuList.get(childPosition).url.equals("etc"))
                {
                    ...
                    HttpAsyncTask question = new HttpAsyncTask(Spring2019_SideMenu.this, new HttpInterface() {
                        @Override
                        public void onResult(String result) {
                            Log.d("hgkim","result : " + result);
                            new PDF(Spring2019_SideMenu.this, result);
                        }

                    });
                    Log.d("hgkim",Global.Spring2017_URL + "program_glance.php");
                    question.execute(new HttpParam("url",Global.Spring2019_URL + "program_glance.php"));
                }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.barcode :
                intent = new Intent(Spring2019_SideMenu.this, Spring2019_BarcodeActivity.class);
                startActivity(intent);
                finish();
                break;
            ...
            case R.id.scrap :
                intent = new Intent(Spring2019_SideMenu.this, Spring2019_WebPage.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent.putExtra("page", "http://ezv.kr/voting/php/session/list.php?code=allergy2019s&tab=-2");
                startActivity(intent);
                finish();
                break;

            case R.id.setting :
                intent = new Intent(Spring2019_SideMenu.this, Spring2019_SettingActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
                break;
            ...
            case R.id.home :
                intent = new Intent(Spring2019_SideMenu.this, Spring2019_MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
                break;
            case R.id.login :
                intent = new Intent(Spring2019_SideMenu.this, Spring2019_LoginActivity.class);
                intent.putExtra("check", 1);
                startActivity(intent);
                finish();
                break;
            ...
            case R.id.logout :
                ...
                editor.putString("Spring2019_sid", "");
                editor.putString("Spring2019_gubun", "");
                editor.putString("Spring2019_name","");
                editor.putString("Spring2019_email", "");
                editor.commit();
